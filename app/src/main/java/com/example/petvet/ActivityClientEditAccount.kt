...
class ActivityClientEditAccount : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tvEdit.setOnClickListener {
            val intent = Intent(this, ActivityClientChangeAccount::class.java)
        ...
        fileRef.putFile(uri).addOnSuccessListener {
            fileRef.downloadUrl.addOnSuccessListener { uri ->
                ...
                clientProfile.child(auth.currentUser?.uid.toString()).setValue(clientProfileData).addOnCompleteListener{
                    Toast.makeText(this@ActivityClientEditAccount,"Profile Updated",Toast.LENGTH_SHORT).show()
                    val intent = Intent(this,AuthenticatedClientActivity::class.java)
                    startActivity(intent)
                }
    }
