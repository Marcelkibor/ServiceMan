...
class VetRegisterActivity : AppCompatActivity() {
            ...
            if (locationIsEnabled()){
                ...
                fusedLocationProviderClient.lastLocation.addOnCompleteListener(this){
                    ...
                    if (location==null){
                        ...
                        val vetLocationDB = FirebaseDatabase.getInstance().getReference("DoctorLocation")
...
private fun checkCredentials() {
    ...
    if (username.text.toString().isEmpty()) {
        ...
        val dialog = Dialog(this@VetRegisterActivity)
...
.addOnCompleteListener { task->
    if (task.isSuccessful){
        val doctorDbRef = FirebaseDatabase.getInstance().getReference("Doctor")
        ...
        if (userId != null) {
            ...
            doctorDbRef.child(userId).setValue(newDoc).addOnCompleteListener {
                ...
                startActivity(intent)
                doctorID = userId
                Toast.makeText(this@VetRegisterActivity,"Successfully Registered",Toast.LENGTH_SHORT).show()
                getVetLocation()
                finish()
            }
        }
