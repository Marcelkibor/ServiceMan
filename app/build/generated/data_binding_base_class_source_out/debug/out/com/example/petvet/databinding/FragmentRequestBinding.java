...
public final class FragmentRequestBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView requestRv;

  @NonNull
  public final TextView tvListStatus;

  private FragmentRequestBinding(@NonNull DrawerLayout rootView, @NonNull ImageView backArrow,
      @NonNull CardView cardHeader, @NonNull CardView cardIdentifiers,
      @NonNull TextView greetingText, @NonNull RecyclerView requestRv,
  ...
  public static FragmentRequestBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.requestRv;
      RecyclerView requestRv = ViewBindings.findChildViewById(rootView, id);
      if (requestRv == null) {
        break missingId;
      }
      ...
      return new FragmentRequestBinding((DrawerLayout) rootView, backArrow, cardHeader,
          cardIdentifiers, greetingText, requestRv, tvListStatus);
    }
