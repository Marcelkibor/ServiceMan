...
public final class FragmentClientHomeBinding implements ViewBinding {
  ...
  @NonNull
  public final CardView cardHomeLocation;
  ...
  @NonNull
  public final CardView relativeLayoutBottom;
  ...
  private FragmentClientHomeBinding(@NonNull DrawerLayout rootView,
      @NonNull DrawerLayout ClientDrawerLayout, @NonNull CardView accountCardView,
      @NonNull CardView cardCompletedOrders, @NonNull CardView cardHomeLocation,
      @NonNull CardView cardSearch, @NonNull CardView cardTrack, @NonNull CardView cardWallet,
      ...
      @NonNull CardView relativeLayoutBottom, @NonNull TextView tvMyServices,
    ...
    this.cardHomeLocation = cardHomeLocation;
    ...
    this.relativeLayoutBottom = relativeLayoutBottom;
  ...
  public static FragmentClientHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.cardHomeLocation;
      CardView cardHomeLocation = ViewBindings.findChildViewById(rootView, id);
      if (cardHomeLocation == null) {
        break missingId;
      }
      ...
      id = R.id.relativeLayoutBottom;
      CardView relativeLayoutBottom = ViewBindings.findChildViewById(rootView, id);
      if (relativeLayoutBottom == null) {
        break missingId;
      }
      ...
      return new FragmentClientHomeBinding((DrawerLayout) rootView, ClientDrawerLayout,
          accountCardView, cardCompletedOrders, cardHomeLocation, cardSearch, cardTrack, cardWallet,
          clientDisplayName, clientNavBar, drawerHome, drawerIcon, greetingText, ltService,
          relativeLayout2, relativeLayoutBottom, tvMyServices, vetFrameLayout, vetNavBar);
    }
