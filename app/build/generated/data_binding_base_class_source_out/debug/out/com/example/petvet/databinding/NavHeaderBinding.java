...
public final class NavHeaderBinding implements ViewBinding {
  ...
  private NavHeaderBinding(@NonNull LinearLayout rootView, @NonNull ImageView docImg) {
  ...
  public static NavHeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.docImg;
      ImageView docImg = ViewBindings.findChildViewById(rootView, id);
      if (docImg == null) {
        break missingId;
      }

      return new NavHeaderBinding((LinearLayout) rootView, docImg);
    }
